...
public class YourPetAdapter extends RecyclerView.Adapter<YourPetAdapter.PetViewHolder> {
    ...
    public YourPetAdapter(List<Pets> petList) {
    ...
    public PetViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.your_pet_list, parent, false);
