...
public class DonationRequestAdapter extends RecyclerView.Adapter<DonationRequestAdapter.DonationView> {
    ...
    public DonationRequestAdapter(List<Donation> donationList) {
    ...
    public DonationView onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.donation_request_list, parent, false);
